...
Weight = np.dtype([("isFixed", np.bool_),        #Whether the weight needs to be learned, it needs to be false, otherwise it is true
                   ("parameterize",np.bool_),    #Does this weight need to be parameterized, 0,1
